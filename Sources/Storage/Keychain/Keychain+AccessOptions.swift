...
public extension Keychain.Manager {
    ...
    enum AccessOption {
        ...
        ///
        /// - Items with this attribute migrate to a new device when using encrypted backups.
        @available(iOS, introduced: 4.0, deprecated: 12.0, message: "Use an accessibility level that provides some user protection, such as .accessibleAfterFirstUnlock")
        case accessibleAlways ///
      
        /// Access is provided regardless of whether the device is locked.
        ///
        /// - Items with this attribute do not migrate to a new device.
        @available(iOS, introduced: 4.0, deprecated: 12.0, message: "Use an accessibility level that provides some user protection, such as .accessibleAfterFirstUnlockThisDeviceOnly")
